...
class Movie:
    ...
    def _get_unique_string_rep(self):
        return f"{self._title}, {self._release_year}"

    def __repr__(self):
        return f'<Movie {self._get_unique_string_rep()}>'

    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return self._get_unique_string_rep() == other._get_unique_string_rep()
    ...
    def __hash__(self):
        return hash(self._get_unique_string_rep())
...
class Review:
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return other.movie == self._movie and other.review_text == \
               self._review_text and other.rating == self._rating and \
               other.timestamp == self._timestamp

    def __repr__(self):
        return f'<Review of movie {self._movie}, rating = {self._rating}, ' \
...
class User:
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return other.user_name == self._user_name
